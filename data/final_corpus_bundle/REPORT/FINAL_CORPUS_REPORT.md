...
**Bundle location:** `data/final_corpus_bundle/` (repository root)
...
**Processing pipeline:** `src/raw_to_embedding/corpus_build/pilot_single_pdf.py` (semantic chunking with structural splitting, sentence overlap, three-pass merging, boilerplate removal)
...
**Processing pipeline:** `src/raw_to_embedding/corpus_build/website_to_chunks.py`
...
BUNDLE = "data/final_corpus_bundle/merged"
